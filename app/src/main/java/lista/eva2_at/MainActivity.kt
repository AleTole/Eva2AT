...
import lista.eva2_at.db.Compra
import lista.eva2_at.db.ComprasDao
import lista.eva2_at.db.DBHelper
...
fun PantallaPrincipalUI(navController: NavController) {
    ...
    Scaffold(
        ...
        //Si nuestra lista esta vacia mostrata el mensaje de No hay productos que mostrar
        if (compras.isEmpty()) {
            Column(
